...
@WebServlet(urlPatterns = "/ElectricServlet", description = "search electric")
public class ElectricServlet extends HttpServlet {
    ...
    public void process(HttpServletRequest request, HttpServletResponse response) throws IOException, XPathExpressionException {
        ...
        XPathExpression xPathExpression = xPath.compile("//car[consumption[@type = 'electric']]/manufacturer | //car[consumption[@type = 'electric']]/model | //car[consumption[@type = 'electric']]/production-year | //car[consumption[@type = 'electric']]/horsepower | //car[consumption[@type = 'electric']]/consumption | //car[consumption[@type = 'electric']]/price");
